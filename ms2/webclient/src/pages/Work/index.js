        ...
        <Form form={form} name="horizontal_login" layout="inline" onFinish={onSearch}>
          <Space gutter={[16,16]} wrap>
            ...
            <Form.Item
              name="workyear"
            >
              <Input placeholder="搜索年份" type="number" allowClear min={1946} />
            </Form.Item>
            <Form.Item
              name="workmouth"
            >
              <Input placeholder="搜索月份" type="number"  allowClear min={1} max={12} />
            </Form.Item>
            <Form.Item
              name="worktype"
            >
